...
<div class="d-flex" id="wrapper">
			...
			<div class="border-end bg-white" id="sidebar-wrapper">
			    ...
			    <div class="list-group list-group-flush">
			        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/carpenterDashboard.jsp">Dashboard</a>
			        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/carpenterUI.jsp">Carpenter Workspace</a>
			        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="/carpenterDoneComplaints.jsp">Done Complaints</a>
			    </div>
			</div>
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid bg">
					...
					<tr>
				    	...
				    	<td><a href='carpenterUI.jsp/carpenter/done/<%out.println(resultSet.getString("complaint_id")); %>/<%=session.getAttribute("USER_ID")%>'>Done</a></td>
