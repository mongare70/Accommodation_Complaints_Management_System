...
<button type="button" class="btn btn-primary btn-lg" onClick="window.location.href='securityUI.jsp'">Back</button>
			...
			String sql ="SELECT * FROM complaints WHERE complaint_status = 'done' AND complaint_category = 'security' AND complaint_done_by = "+ session.getAttribute("USER_ID") +" AND complaint_claimed_by = "+ session.getAttribute("USER_ID") +" ORDER BY complaint_id DESC";
