...
<div class="container-fluid bg">
		<div class="row">
			...
			<h2 align="center"><font><strong>Welcome ${security.fname} Here are the Complaints:</strong></font></h2>
		    ...
		    <input type="hidden" id="scid" name="scid" value="<%=resultSet.getString("scid")%>">
